"""
Thank you Vincent Bernardoff and "cincrement" for your work
which this is based off of:
https://github.com/vbmithr/ocaml-bip32-ed25519/blob/master/test/test_vectors/make-bip32-ed25519-test-vectors.py
...
def special_signing(kL, kR, A,
                    M):  # private/secret key left and right sides kL & kR, public key A, and message M in bytes
    r = h512(kR + M)
...
# (https://drive.google.com/file/d/0ByMtMw2hul0EMFJuNnZORDR2NDA/view)
